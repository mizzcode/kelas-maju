					...
					<div class="container">
						...
						<div class="collapse navbar-collapse font-secondary" id="site-collapse-nav">
							<ul class="nav nav-list navbar-nav navbar-right">
								...
								<li><a class="nav-item" href="#students">Students</a></li>
								<li><a class="nav-item" href="#teachers">Teachers</a></li>
								<li><a class="nav-item" href="#mapels">Mapels</a></li>
							</ul>
						</div><!-- /.navbar-collapse -->
					</div><!-- /.container -->
				</nav>
											...
											<div class="team-profile-info">
												...
												<div class="my-skills">
                                                    ...
                                                    <div class="text-left">
                                                        ...
                                                        <img src="{{asset("assets/images/css.png")}}" width="50" 
                                                        alt="CSS">
                                                        <img src="{{asset("assets/images/javascript.png")}}" width="50" 
                                                        alt="JS">
                                                        <img src="{{asset("assets/images/nodejs.png")}}" width="50" 
                                                        alt="NODEJS">
                                                        <img src="{{asset("assets/images/php.png")}}" width="50" 
                                                        alt="PHP">
